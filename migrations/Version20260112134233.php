 ...
 */
final class Version20260112134233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gender (id INT AUTO_INCREMENT NOT NULL, sexe VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE candidat ADD gender_type_id INT DEFAULT NULL, DROP gender');
        ...
        $this->addSql('CREATE INDEX IDX_6AB5B47137A4F92F ON candidat (gender_type_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6AB5B47137A4F92F ON candidat');
        $this->addSql('ALTER TABLE candidat ADD gender VARCHAR(255) DEFAULT NULL, DROP gender_type_id');
