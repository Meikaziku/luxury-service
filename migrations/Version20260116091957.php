 ...
 */
final class Version20260116091957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE society_name society_name VARCHAR(255) DEFAULT NULL, CHANGE activity_type activity_type VARCHAR(255) DEFAULT NULL, CHANGE contact_name contact_name VARCHAR(255) DEFAULT NULL, CHANGE poste poste VARCHAR(255) DEFAULT NULL, CHANGE contact_phone contact_phone INT DEFAULT NULL, CHANGE contact_email contact_email VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE society_name society_name VARCHAR(255) NOT NULL, CHANGE activity_type activity_type VARCHAR(255) NOT NULL, CHANGE contact_name contact_name VARCHAR(255) NOT NULL, CHANGE poste poste VARCHAR(255) NOT NULL, CHANGE contact_phone contact_phone INT NOT NULL, CHANGE contact_email contact_email VARCHAR(255) NOT NULL');
