 ...
 */
final class Version20260116100321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE contact_phone contact_phone VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE contact_phone contact_phone INT DEFAULT NULL');
